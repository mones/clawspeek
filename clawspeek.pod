...
=item Only Claws Mail versions below 3.14.0 are fully supported.
Limited support for greater versions: when not using the new master
password mechanism, see README for details.
